# -*- coding: utf-8 -*-
"""
Created on Sat Jul  7 14:08:15 2018
...
frase_original = open("texto_original.txt", "r").read()
...
frase_codificada_txt = open("texto_codificado.txt", "w").writelines(frase_codificada)
